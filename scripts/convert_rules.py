...
#
# NOTE: making-attacks and generating-a-battle are no longer excluded. Both are
# auto-generated by convert_rules.py and then post-processed by run_all.py:
#   - making-attacks: RollTable imports and components are injected after generation
#   - generating-a-battle: ObjectiveGrid component is injected after generation
# See run_all.py for the injection logic.
EXCLUDE_SLUGS = {
