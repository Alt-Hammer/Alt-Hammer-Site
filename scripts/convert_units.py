...
convert_units.py
────────────────
Converts the Countermarch Unit Data Tables Excel file (.xlsx) into JSON
files for the website's unit stat blocks and list builder.

SOURCE FILE
───────────
Countermarch 40,000 1st Edition - Unit Data Tables by Faction.xlsx
...
from source_paths import UNIT_DATATABLES_XLSX
...
def convert_units(xlsx_path: str, output_dir: str):
    print(f"\n{'='*60}")
    print(f"  Countermarch — Converting Unit Data Tables")
    print(f"{'='*60}")
